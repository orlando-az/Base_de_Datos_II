-- Ejercicio 1: 
-- Calcular el stock total de cada producto sumando las cantidades disponibles 
-- en ProductInventory y mostrar el ID y nombre del producto junto con su total 
-- de stock, ordenando los resultados de mayor a menor cantidad.
